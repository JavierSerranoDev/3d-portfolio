const projects = [
    {
        ...
        html: 
        `
                <div>This is the full content of my first blog post. It goes into detail about the topic I am discussing and provides valuable information to the reader.</p>
                <div>Here is some more content for my blog post. I can include images, links, and other media to make it more engaging for the reader.</p>
                ...
                <div>Finally, I will conclude my blog post with a summary of the key points and a call to action for the reader to engage with the content.</p>
        `,
        media : [
            {
    ...
    },
    {
        ...
        description: "Chente Te Canta Desde El Cielo was a website developed for the family of Vicente 'Chente' Fernandez, a famous Mexican singer, to honor his legacy and provide a platform for fans to celebrate his life and music along with Sony Music Latin and Spotify. The website featured a AR experience where user could see stunning videos of Chente performing in different stages of his career, along a particle system for petals. We used 8th Wall for the AR experience and Unity WebGL for the website, creating an engaging and interactive experience for users to celebrate Chente's legacy and music effectively.",
        html: "",
        media : [
            {
        ...
        "tools" : [
            {
                "id" : 3,
                "responsibilities" : [
                    "As team lead I was responsible for leading the development of the website and ensuring that the project was completed successfully. Managing the git repository, creating and managing branches for my responsibilities, ensuring that my work was properly organized and integrated with the main codebase.",
        ...
        "tools" : [
            {
                "id" : 3,
                "responsibilities" : [
                    "Had to administer the git repository for this project, creating and managing branches for my responsibilities, ensuring that my work was properly organized and integrated with the main codebase.",
    ...
    },
    {
        ...
        description: "This was a website developed for the North Face brand in Mexico by RCK Games along with CoolNerdyPeople. The website was developed using React and Unity WebGL, providing an interactive and engaging experience for users to explore North Face's advertising 'Global Warming Series'. The website featured a visually stunning design, showcasing North Face's ideas in a unique and immersive way, showcasing 3D models and interactive elements to engage users and promote the brand's message effectively.",
        media : [
            {
    ...
    },
    {
        ...
        description: "Jurassic Tycoon was a game developed in Roblox Studio for aRoblox that hunted teams in latin america to develop games for their platform. The game featured a tycoon gameplay where players had to manage their own dinosaur park, collecting the dinosaurs, building attractions, and managing resources to grow their park and attract more visitors. The game was developed in Roblox Studio, utilizing its powerful tools and features to create an engaging and immersive gaming experience for players.",
        html: "",
        media : [
            {
        ...
        "tools" : [
            ...
            },
            {
                ...
                "responsibilities" : [
                    ...
                    "In this project I was still a junior developer, so I was responsible for creating and managing branches for my responsibilities, ensuring that my work was properly organized and integrated with the main codebase.",
                ],
            }
        ],
        "experiences" : []
